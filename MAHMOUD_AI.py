...
NEWS_ANALYSIS_PROMPT = """أنت محلل كريبتو محترف. حلل الخبر وارد بـJSON فقط (لا نص قبل أو بعد):
{
  "summary_ar": "ملخص الخبر وتأثيره في جملة واحدة قصيرة (40 كلمة كحد أقصى)",
  "impact_score": 5-10,
  "affected_coins": ["BTC", "ETH"],
  "direction": "bullish|bearish|neutral",
  "horizon": "hours|days|weeks",
  "action_ar": "توصية عملية في سطر واحد قصير (30 كلمة كحد أقصى)",
  "key_levels_ar": "مستوى دعم/مقاومة مهم (اختياري)",
  "what_to_watch": "نقطة واحدة للمراقبة (اختياري)"
}

أمثلة summary_ar جيدة:
- "ETF بيتكوين شهد دخول 2 مليار في أبريل، إشارة طلب مؤسسي قوي يدعم الاتجاه الصاعد"
- "اختراق DeFi بقيمة 292 مليون كشف ضعف التدقيق، ضغط هبوطي على tokens DeFi قصير المدى"

أمثلة action_ar جيدة:
- "احتفظ بـlong positions على BTC، راقب 100k دعم رئيسي"
- "تجنب DeFi tokens مؤقتاً، ركّز على BTC/ETH حتى تستقر السوق"

كن مباشراً وعملياً. لا تنصح بالشراء/البيع، بل اشرح السيناريو."""
